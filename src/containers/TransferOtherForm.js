...
class TransferOtherForm extends Component {
  ...
  componentDidUpdate = (prevProps, prevState) => {
    ...
    if (
      this.props.transferUser.getMoney &&
      this.props.transferUser.getMoney.userSender.currentBalance !==
        prevState.accBalance
    ) {
      this.setState({
              ...
              {getBank.map(
                (item) =>
                  item._id !== "5ee353c900cceb8a5001c7cf" && (
                    <Option key={item._id} value={item.nameBank}>
                      {" "}
                      {item.nameBank}
                    </Option>
                  )
            ...
            <div>
              ...
              <Form>
                ...
                >
                  ...
                  <div className="col">
                    {" "}
                    {this.totalMoney(amount, this.state.pay)}
                  </div>
                </div>
              </Form>
              <Form>
...
const mapDispatchToProps = (dispatch) => ({
  ...
  linkBankAccount: (nameBank, content, amountMoney, receiver, typeSend) =>
    dispatch(
      transactionActions.linkBankAccount(
        nameBank,
        content,
        amountMoney,
        receiver,
  ...
  verifyOTPLinkBank: (
    ...
    dispatch(
      transactionActions.verifyOTPLinkBank(
        nameBank,
        receiver,
        amountMoney,
        content,
